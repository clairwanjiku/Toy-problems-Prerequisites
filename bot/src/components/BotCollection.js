        ...
        <div key={bot.id} className="col-3 mb-4">
          <div className="card">
            ...
            <div className="card-body">
              ...
              <button onClick={() => handleEnlist(bot)} className="btn btn-info">Enlist</button>
              <button onClick={() => handleViewDetails(bot)} className="btn btn-secondary">View Details</button>
